...
import SwitchCheckedIcon from '../Components/Icons/SwitchCheckedIcon';
import SwitchUncheckedIcon from '../Components/Icons/SwitchUnckeckedIcon';
    ...
    MuiSwitch: {
      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            '& .MuiSwitch-track': {
              backgroundColor: corePalette.grey200,
            }
          },
        },
        switchBase: {
